console.log("Loaded angular login module");
var app = angular.module('loginApp', ["ngResource","ngRoute","ngCookies","angular-jwt"]);

app.controller('loginController', function($scope,$resource,$http,$httpParamSerializer,$cookies,jwtHelper,$timeout) {
    ...
    function getOrganization(){
    	...
    	//JDBC
    	 <!--$http.get("http://localhost:5000/spring-security-oauth-resource/users/extra")-->
